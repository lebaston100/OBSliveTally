...
By default it is setup to connect to the IP of the machine you run it on. You can change that default start value by editing the IP address and/or the port in line 8.
